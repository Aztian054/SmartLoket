...
<body>
    ...
    @include('partials.kop_surat', ['subtitle' => 'REKAPITULASI LAPORAN PELAYANAN LOKET & MONITORING BERKAS'])

    <p style="text-align:center; font-size:10px; margin:-4px 0 14px;">
        ...
        <tbody>
            @forelse($tikets as $idx => $t)
                <tr>
                    ...
                    <td style="font-weight: bold;">{{ $t->kode_tiket }}</td>
            ...
            @empty
                <tr>
                    <td colspan="8" style="text-align: center; padding: 20px;">Tidak ada data permohonan.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
